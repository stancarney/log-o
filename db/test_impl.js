...
function reset() {
  ...
  saveUser({email: 'admin', password: bcrypt_admin, active: true, permissions: ['USER_ADD', 'USER_LIST', 'USER_EDIT', 'USER_RESET', 'ALERT_ADD', 'ALERT_LIST', 'ALERT_EDIT', 'SEARCH', 'TAIL']});
  saveUser({email: 'logo@example.com', password: bcrypt_password, active: true, permissions: ['USER_ADD', 'USER_LIST', 'USER_EDIT', 'USER_RESET', 'ALERT_ADD', 'ALERT_LIST', 'ALERT_EDIT', 'SEARCH', 'TAIL']});
}
